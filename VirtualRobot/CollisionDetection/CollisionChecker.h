...
public:
	...
	*/
	...
	void enableDebugOutput(bool e){debugOutput = e;collisionCheckerImplementation->enableDebugOutput(e);}
	bool debugOutput;
...
#if defined(VR_COLLISION_DETECTION_PQP)
	boost::shared_ptr<CollisionCheckerPQP> getCollisionCheckerImplementation(){return collisionCheckerImplementation;}
#else
	boost::shared_ptr<CollisionCheckerDummy> getCollisionCheckerImplementation(){return collisionCheckerImplementation;}
#endif
